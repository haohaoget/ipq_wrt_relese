...
remove_unwanted_packages() {
    local luci_packages=(
        ...
        "luci-app-msd_lite" "luci-app-unblockneteasemusic" "luci-app-dockerman"
    )
    local packages_net=(
...
# quickstart luci-app-quickstart luci-app-istorex 
    ./scripts/feeds install -p small8 -f xray-core xray-plugin dns2tcp dns2socks haproxy hysteria \
        ...
        luci-theme-argon luci-app-argon-config luci-app-cloudflarespeedtest netdata luci-app-netdata \
        lucky luci-app-lucky luci-app-openclash luci-app-homeproxy luci-app-amlogic nikki luci-app-nikki \
        luci-app-transmission transmission-web-control transmission\
        tailscale luci-app-tailscale oaf open-app-filter luci-app-oaf easytier luci-app-easytier \
        msd_lite luci-app-msd_lite cups luci-app-cupsd luci-app-dockerman
}
